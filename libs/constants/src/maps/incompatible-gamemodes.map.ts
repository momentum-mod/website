...
export const IncompatibleGamemodes: ReadonlyMap<Gamemode, ReadonlySet<Gamemode>> = new Map(
  [
    [G.SURF,        [Cats(GC.BHOP, GC.CLIMB), G.DEFRAG_VTG]],
    [G.BHOP,        [Cats(GC.SURF)]],
    [G.BHOP_HL1,    [Cats(GC.SURF)]],
    [G.CLIMB_MOM,   [Cats(GC.SURF, GC.BHOP), G.DEFRAG_VTG]],
    [G.CLIMB_KZT,   [Cats(GC.SURF, GC.BHOP), Gamemode.DEFRAG_VTG]],
    [G.CLIMB_16,    [Cats(GC.SURF, GC.BHOP), G.DEFRAG_VTG]],
    [G.RJ,          []],
    [G.SJ,          []],
    [G.AHOP,        []],
    [G.CONC,        []],
