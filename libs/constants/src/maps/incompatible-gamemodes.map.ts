import { Gamemode as G, GamemodeCategories, GamemodeCategory as GC } from '../';
...
const Cats = (...gcs: GC[]) => gcs.flatMap((gc) => GamemodeCategories.get(gc)!);
 ...
 */
// prettier-ignore
export const IncompatibleGamemodes: ReadonlyMap<G, ReadonlySet<G>> = new Map(
  [
