...
describe('StatsService', () => {
  ...
  describe('Unit Tests', () => {
    ...
    it('#getGlobalBaseStats should return expected base stats ', () => {
      ...
      statsService.getGlobalBaseStats().subscribe(
        value => expect(value).toEqual(expectedGlobalBaseStats, 'expected base stats'),
        fail,
      );
    ...
    it('#getGlobalMapStats should return expected map stats ', () => {
      ...
      statsService.getGlobalMapStats().subscribe(
        value => expect(value).toEqual(expectedGlobalMapStats, 'expected map stats'),
        fail,
      );
      expect(httpClientSpy.get.calls.count()).toBe(1, 'one call');
    });
