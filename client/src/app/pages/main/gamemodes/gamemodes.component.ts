...
export class GamemodesComponent implements OnDestroy {
  ...
  gameModes: GameModeDetails[] = [
    ...
    },
    {
      ...
      guideUrl: '/guide/gamemodes/rocket_jump',
      isImplemented: true,
      useYoutubeEmbed: false,
    },
    {
      ...
      guideUrl: '/guide/gamemodes/sticky_jump',
      isImplemented: true,
      useYoutubeEmbed: false,
    },
    {
    ...
    },
    {
      ...
      imageUrl: '/assets/images/gamemode_conc.webp',
      iconUrl: '/assets/images/gamemode_icons/site_conc.webp',
      guideUrl: '/guide/gamemodes/conc',
      isImplemented: true,
      useYoutubeEmbed: false,
    },
    {
      ...
      guideUrl: '/guide/gamemodes/defrag',
      isImplemented: false,
      useYoutubeEmbed: true,
      playingYoutubeEmbed: false,
      youtubeVidID: 'eZuRfJl3STc',
    },
    {
      url: '',
      modeTitle: 'Tricksurf',
      ...
      guideUrl: '/guide/gamemodes/tricksurf',
      isImplemented: false,
      useYoutubeEmbed: true,
      playingYoutubeEmbed: false,
    ...
    },
    {
      ...
      guideUrl: '/guide/gamemodes/parkour',
      isImplemented: false,
      useYoutubeEmbed: true,
      playingYoutubeEmbed: false,
    ...
    },
    {
      ...
      guideUrl: '/guide/gamemodes/climb',
      isImplemented: false,
      useYoutubeEmbed: true,
      playingYoutubeEmbed: false,
