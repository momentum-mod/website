...
export class SteamAuthService {
    ...
    async ValidateFromInGame(userTicketRaw: any, steamIDToVerify: string): Promise<User> {
        ...
        if (!userTicket && !steamIDToVerify) { throw new HttpException('Bad Request', 400); }
    ...
    async verifyUserTicketLocalLibrary(userTicketRaw: any, steamIDToVerify: string) {
        ...
        if ( decrypted.appID !== 669270 && decrypted.appID !== 1802710 && decrypted.steamID.getSteamID64() !== steamIDToVerify ) {
