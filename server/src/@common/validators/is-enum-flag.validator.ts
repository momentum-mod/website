...
export function IsEnumFlag(property: unknown, validationOptions?: ValidationOptions) {
        ...
        registerDecorator({
            ...
            validator: {
                validate(value: any, args: ValidationArguments) {
                    ...
                    const relatedValue = (args.object as any)[propertyName] as number;
                    ...
                    return Number.isInteger(relatedValue) && relatedValue < 1 << (Object.keys(enumObject).length / 2);
                },
