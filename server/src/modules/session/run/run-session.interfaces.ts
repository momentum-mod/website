import { BaseStats as BaseStatsDB, Prisma, Rank, Run as RunDB } from '@prisma/client';
...
export type ReplayHeader = Omit<Replay, 'overallStats' | 'zoneStats' | 'frames'>;
...
export type BaseStatsFromGame = Omit<BaseStatsDB, 'id' | 'createdAt' | 'updatedAt'>;
