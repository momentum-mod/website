...
export type RunSessionCompleted = Prisma.RunSessionGetPayload<
...
export class RunsRepoService {
  ...
  createRunSession(
    data: Prisma.RunSessionCreateInput,
    include?: Prisma.RunSessionInclude
  ): Promise<RunSession> {
    return this.prisma.runSession.create({ data: data, include: include });
  }

  getRunSession(
    where: Prisma.RunSessionWhereInput,
    include?: Prisma.RunSessionInclude
  ): Promise<RunSession> {
  ...
  deleteRunSessionUnique(
    where: Prisma.RunSessionWhereUniqueInput
  ): Promise<RunSession> {
    // If this errors we want to catch in service logic
    return this.prisma.runSession.delete({ where: where });
  }

  createRunSessionTimestamp(
    data: Prisma.RunSessionTimestampCreateInput
  ): Promise<RunSessionTimestamp> {
  ...
  createRunZoneStats(
    data: Prisma.RunZoneStatsCreateInput
  ): Promise<RunZoneStats> {
    return this.prisma.runZoneStats.create({ data: data });
  }

  getRunZoneStats(
    where: Prisma.RunZoneStatsWhereInput,
    include?: Prisma.RunZoneStatsInclude
  ) {
  ...
  updateRunZoneStats(
    where: Prisma.RunZoneStatsWhereUniqueInput,
    data: Prisma.RunZoneStatsUpdateInput
  ) {
  ...
  batchUpdateRank(
    ...
    return this.prisma.$transaction(
      updates.map((u) =>
        this.prisma.rank.update({ where: u.where, data: u.data })
      )
    );
  }
