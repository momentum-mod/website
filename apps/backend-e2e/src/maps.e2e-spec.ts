...
describe('Maps', () => {
  ...
  describe('maps/{mapID}', () => {
    ...
    describe('DELETE', () => {
      ...
      afterEach(() => db.cleanup('mMap', 'user', 'leaderboardRun'));

      // should successfully delete a map and all related stored data if map is in submission
      // TODO: MORE! Leaderboards!
